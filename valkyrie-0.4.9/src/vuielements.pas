...
unit vuielements;
interface
uses SysUtils, vnode, viotypes, vioevent, vuitypes, vuielement, vgenerics;
...
type TUICustomStringList = class( TUICustomScrollable )
...
type TUICustomMessages = class( TUICustomScrollable )
  ...
  procedure Add( const aMessage : Ansistring ); reintroduce;
  // Handle more case
